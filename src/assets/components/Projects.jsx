...
const Projects = () => {
    ...
    return (
        <div className="relative w-[200px] lg:w-[1900px] md:w-[849px] overflow-x-hidden flex p-10 justify-center items-center" id="projects">
            <Slider {...settings} className="w-full">
                {projectData.map((project, index) => (
                    <div key={index}>
                        <div className="max-w-sm mx-auto bg-green-700/30 border border-gray-200 rounded-lg shadow dark:bg-gray-800 dark:border-gray-700">
                            <a href={project.link}>
                            ...
                            <div className="p-5">
                                ...
                                <a href={project.link} className="inline-flex items-center px-3 py-2 text-sm font-medium text-center text-white bg-green-700 rounded-lg hover:bg-green-800  ">
                                    Read more
