...
const Content = () => {
  ...
  return (
    <div className="relative flex flex-col lg:flex-row px-4 lg:px-8 py-8 sm:w-screen sm:h-screen sm:px-4 sm:py-4 items-center text-center justify-center h-screen" id="home">
