...
const Skills = () => {
  return (
    <div className="relative mt-10 skills-container h-screen flex justify-center items-center p-2 lg:px-44 md:px-16 backdrop-blur-sm bg-transparent rounded-lg shadow-lg text-black" id="skills">
